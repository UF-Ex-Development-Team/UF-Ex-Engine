...
internal partial class GameMain : Game
{
	...
	protected override void Draw(GameTime gameTime)
	{
		...
		if (DebugState.ShowRenderCost)
		{
			...
			RenderTicks = RenderTimer.ElapsedTicks;
		}
#endif
		base.Draw(gameTime);
	}
	...
	/// </summary>
	public static long RenderMs { get; private set; }
	/// <summary>
	/// Ticks taken to render
	/// </summary>
	public static double RenderTicks { get; private set; }
}