...
namespace UndyneFight_Ex.Fight
{
    public static class ClassicFight
    {
        ...
        public static void StartBattle() => isInBattle = true;
        ...
        public static void CreateItem(Item i) => items.Add(i);
        public static void CreateAction(GameAction i) => actions.Add(i);
