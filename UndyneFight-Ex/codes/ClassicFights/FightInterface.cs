...
namespace UndyneFight_Ex.Fight
{
    public abstract class FightSelection : Entity
    {
        ...
        protected bool GetCollide() => Player.heartInstance != null && GetCollide(Player.heartInstance);
        protected bool GetCollide(Player.Heart player) => collidingBox.Contain(player.Centre);
    ...
    public abstract class FightTextSelection : FightSelection
    {
        ...
        protected bool IsCollide { get; private set; }
        ...
        public override void Draw() => Font.NormalFont.CentreDraw(Text, Centre, IsCollide ? Color.Lerp(drawingColor, Color.Gold, 0.5f) : drawingColor, 1.0f, 0.0f);
        public override void Update()
        {
    ...
    public class FightSelectionCollection : Entity
    {
        ...
        public override void Draw()
        {
            if (this != MainMenu)
                MainMenu.Draw();
            foreach (FightSelection v in selections)
                v.Draw();
        }
        ...
        public void Teleport() => Player.heartInstance.Teleport(selections[currentSelection].HeartStayPosition);
    ...
    internal class FightVirtualObject : GameObject
    {
        ...
        public override void Update()
        {
            classicFight.Update();
            if (isInBattle)
                _ = FightStates.enemys.RemoveAll(s => s.Disposed);
        }
        public override void Dispose()
        {
