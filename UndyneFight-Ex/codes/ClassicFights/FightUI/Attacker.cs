...
namespace UndyneFight_Ex.Fight
{
    internal class AttackTrail : Entity
    {
        ...
        public override void Draw() => FormalDraw(Image, Centre, Color.White, 0, ImageCentre);
    ...
    internal class AttackTarget : Entity
    {
        ...
        public override void Draw() => GameMain.MissionSpriteBatch.Draw(Image, Centre, null, Color.White * alpha, 0, ImageCentre, new Vector2(alpha, 1.0f), SpriteEffects.None, 0.5f);
    ...
    public abstract class AttackAnimation : Entity
    {
        ...
        public AttackAnimation() => instance = this;
