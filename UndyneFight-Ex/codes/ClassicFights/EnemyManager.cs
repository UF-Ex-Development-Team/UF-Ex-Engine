...
namespace UndyneFight_Ex.Fight
{
    public abstract class Enemy : Entity
    {
        ...
        public float MissChance { internal get; set; }
        public float Defence { internal get; set; }
        public float HPBarLength { internal get; set; } = 240;
        ...
        private class DamageShower : Entity
        {
            ...
            public override void Update()
            {
                ...
                speed.Y += 9.0f / 60f;
                Centre += speed;
                if (Centre.Y >= normalHeight)
                { speed.Y = -speed.Y * 0.4f; speed.X *= 0.3f; Centre = new Vector2(Centre.X, normalHeight); }
