...
namespace UndyneFight_Ex.Debugging
{
    ...
    internal abstract class IColorStyle
    {
        ...
        public Color GetColor(WordType type) => type switch
        {
    ...
    internal class ColorStyleManager : ISetAble
    {
        ...
        private readonly Dictionary<string, IColorStyle> allColors = [];
        public Color GetColor(WordType type) => currentStyle.GetColor(type);

        public void SetTo(string settings) => throw new NotImplementedException();
