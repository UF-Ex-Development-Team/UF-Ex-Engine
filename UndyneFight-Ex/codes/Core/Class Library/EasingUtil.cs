...
namespace UndyneFight_Ex.Entities
{
    ...
    /// NOTE THAT EaseIn*, EaseInOut*, EaseOutIn* functions may return inaccurate results,
    /// TK is currently investigating this issue
    /// </summary>
    public static class SimplifiedEasing
    {
        internal class CEaseBuilder
        {
            ...
            public void Run(Action<Vector2> func)
            {
                ...
                EaseUnit<vec2> ease = GetResult();
                Func<ICustomMotion, vec2> Easer = ease.Easing;
        ...
        {
            CEaseBuilder builder = new() { Adjust = isAdjust };
            foreach (EaseUnit<vec2> func in funcs)
                builder.Insert(func);
            builder.Run(action);
        }
        /// <summary>
        ...
        {
            EasingUtil.ValueEasing.EaseBuilder builder = new() { Adjust = isAdjust };
            foreach (EaseUnit<float> func in funcs)
                builder.Insert(func.Time, func.Easing);
            builder.Run(action);
        }
        /// <summary>
        /// Runs an action with a <see cref="float"/> as it's variable with the given easing functions
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EaseUnit<Vector2> Linear(float time, Vector2 start, Vector2 end) => new(start, end, time, EasingUtil.CentreEasing.Linear(start, end, time));
        /// <summary>
        ...
        /// <returns>The result of the easing</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EaseUnit<float> Linear(float time, float start, float end) => new(start, end, time, EasingUtil.ValueEasing.Linear(start, end, time));
        /// <summary>
        ...
        /// <returns>The result of the easing</returns>
        public static EaseUnit<Vector2> EaseIn(float time, Vector2 start, Vector2 end, EaseState state) => state switch
        {
            EaseState.Linear => new(start, end, time, EasingUtil.CentreEasing.Linear(start, end, time)),
            EaseState.Quad => new(start, end, time, EasingUtil.CentreEasing.EaseInQuad(start, end, time)),
            EaseState.Cubic => new(start, end, time, EasingUtil.CentreEasing.EaseInCubic(start, end, time)),
            EaseState.Quart => new(start, end, time, EasingUtil.CentreEasing.EaseInQuart(start, end, time)),
            EaseState.Quint => new(start, end, time, EasingUtil.CentreEasing.EaseInQuint(start, end, time)),
            EaseState.Circ => new(start, end, time, EasingUtil.CentreEasing.EaseInCirc(start, end, time)),
            EaseState.Sine => new(start, end, time, EasingUtil.CentreEasing.EaseInSine(start, end, time)),
            EaseState.Elastic => new(start, end, time, EasingUtil.CentreEasing.EaseInElastic(start, end, time)),
            EaseState.Expo => new(start, end, time, EasingUtil.CentreEasing.EaseInExpo(start, end, time)),
            EaseState.Back => new(start, end, time, EasingUtil.CentreEasing.EaseInBack(start, end, time)),
            EaseState.Bounce => new(start, end, time, EasingUtil.CentreEasing.EaseInBounce(start, end, time)),
        ...
        /// <param name="state">The type of easing used for the easing function</param>
        /// <returns>The result of the easing</returns>
        public static EaseUnit<Vector2> EaseOut(float time, Vector2 start, Vector2 end, EaseState state) => state switch
        {
            EaseState.Linear => new(start, end, time, EasingUtil.CentreEasing.Linear(start, end, time)),
            EaseState.Quad => new(start, end, time, EasingUtil.CentreEasing.EaseOutQuad(start, end, time)),
            EaseState.Cubic => new(start, end, time, EasingUtil.CentreEasing.EaseOutCubic(start, end, time)),
            EaseState.Quart => new(start, end, time, EasingUtil.CentreEasing.EaseOutQuart(start, end, time)),
            EaseState.Quint => new(start, end, time, EasingUtil.CentreEasing.EaseOutQuint(start, end, time)),
            EaseState.Circ => new(start, end, time, EasingUtil.CentreEasing.EaseOutCirc(start, end, time)),
            EaseState.Sine => new(start, end, time, EasingUtil.CentreEasing.EaseOutSine(start, end, time)),
            EaseState.Elastic => new(start, end, time, EasingUtil.CentreEasing.EaseOutElastic(start, end, time)),
            EaseState.Expo => new(start, end, time, EasingUtil.CentreEasing.EaseOutExpo(start, end, time)),
            EaseState.Back => new(start, end, time, EasingUtil.CentreEasing.EaseOutBack(start, end, time)),
            EaseState.Bounce => new(start, end, time, EasingUtil.CentreEasing.EaseOutBounce(start, end, time)),
            _ => throw new ArgumentOutOfRangeException($"{state} is not a proper easing state", nameof(state))
        };
        /// <summary>
        ...
        /// <returns>The result of the easing</returns>
        public static EaseUnit<Vector2> EaseInOut(float time, Vector2 start, Vector2 end, float amount, EaseState Astate, EaseState? Bstate = null)
        {
            Bstate ??= Astate;
            ...
            A = Astate switch
            {
                ...
                _ => throw new ArgumentOutOfRangeException($"{Astate} is not a proper easing state", nameof(Astate))
            };
            EaseUnit<Vector2> B;
            B = Bstate switch
            {
                ...
                _ => throw new ArgumentOutOfRangeException($"{Bstate} is not a proper easing state", nameof(Bstate))
            };
            return LinkEase(A, B);
        }
        /// <summary>
        ...
        /// <param name="Bstate">Ending easing type (Default <paramref name="Astate"/>)</param>
        /// <returns>The result of the easing</returns>
        public static EaseUnit<Vector2> EaseOutIn(float time, Vector2 start, Vector2 end, float amount, EaseState Astate, EaseState? Bstate = null)
        {
            Bstate ??= Astate;
            float midx = MathHelper.Lerp(start.X, end.X, amount);
            float midy = MathHelper.Lerp(start.Y, end.Y, amount);
        ...
        /// <param name="state">The type of easing used for the easing function</param>
        /// <returns>The result of the easing</returns>
        public static EaseUnit<float> EaseIn(float time, float start, float end, EaseState state) => state switch
        {
            EaseState.Linear => new(start, end, time, EasingUtil.ValueEasing.Linear(start, end, time)),
            EaseState.Quad => new(start, end, time, EasingUtil.ValueEasing.EaseInQuad(start, end, time)),
            EaseState.Cubic => new(start, end, time, EasingUtil.ValueEasing.EaseInCubic(start, end, time)),
            EaseState.Quart => new(start, end, time, EasingUtil.ValueEasing.EaseInQuart(start, end, time)),
            EaseState.Quint => new(start, end, time, EasingUtil.ValueEasing.EaseInQuint(start, end, time)),
            EaseState.Circ => new(start, end, time, EasingUtil.ValueEasing.EaseInCirc(start, end, time)),
            EaseState.Sine => new(start, end, time, EasingUtil.ValueEasing.EaseInSine(start, end, time)),
            EaseState.Elastic => new(start, end, time, EasingUtil.ValueEasing.EaseInElastic(start, end, time)),
            EaseState.Expo => new(start, end, time, EasingUtil.ValueEasing.EaseInExpo(start, end, time)),
            EaseState.Back => new(start, end, time, EasingUtil.ValueEasing.EaseInBack(start, end, time)),
            EaseState.Bounce => new(start, end, time, EasingUtil.ValueEasing.EaseInBounce(start, end, time)),
            _ => throw new ArgumentOutOfRangeException($"{state} is not a proper easing state", nameof(state))
        };
        /// <summary>
        /// Returns an easing function that starts fast and ends slow
        ...
        /// <param name="state">The type of easing used for the easing function</param>
        /// <returns>The result of the easing</returns>
        public static EaseUnit<float> EaseOut(float time, float start, float end, EaseState state) => state switch
        {
            EaseState.Linear => new(start, end, time, EasingUtil.ValueEasing.Linear(start, end, time)),
            EaseState.Quad => new(start, end, time, EasingUtil.ValueEasing.EaseOutQuad(start, end, time)),
            EaseState.Cubic => new(start, end, time, EasingUtil.ValueEasing.EaseOutCubic(start, end, time)),
            EaseState.Quart => new(start, end, time, EasingUtil.ValueEasing.EaseOutQuart(start, end, time)),
            EaseState.Quint => new(start, end, time, EasingUtil.ValueEasing.EaseOutQuint(start, end, time)),
            EaseState.Circ => new(start, end, time, EasingUtil.ValueEasing.EaseOutCirc(start, end, time)),
            EaseState.Sine => new(start, end, time, EasingUtil.ValueEasing.EaseOutSine(start, end, time)),
            EaseState.Elastic => new(start, end, time, EasingUtil.ValueEasing.EaseOutElastic(start, end, time)),
            EaseState.Expo => new(start, end, time, EasingUtil.ValueEasing.EaseOutExpo(start, end, time)),
            EaseState.Back => new(start, end, time, EasingUtil.ValueEasing.EaseOutBack(start, end, time)),
            EaseState.Bounce => new(start, end, time, EasingUtil.ValueEasing.EaseOutBounce(start, end, time)),
            _ => throw new ArgumentOutOfRangeException($"{state} is not a proper easing state", nameof(state))
        };
        /// <summary>
        /// Returns an easing function that starts slow and ends fast <br/>
        ...
        /// <param name="Bstate">Ending easing type (Default <paramref name="Astate"/>)</param>
        /// <returns>The result of the easing</returns>
        public static EaseUnit<float> EaseInOut(float time, float start, float end, float amount, EaseState Astate, EaseState? Bstate = null)
        {
            Bstate ??= Astate;
        ...
        /// <param name="Bstate">Ending easing type (Default <paramref name="Astate"/>)</param>
        /// <returns>The result of the easing</returns>
        public static EaseUnit<float> EaseOutIn(float time, float start, float end, float amount, EaseState Astate, EaseState? Bstate = null)
        {
            Bstate ??= Astate;
            float mid = MathHelper.Lerp(start, end, amount);
            EaseUnit<float> B;
        ...
        {
            float sine(float t) => MathHelper.Lerp(start, end, MathF.Sin((t / T + phase) * MathF.PI * 2) * 0.5f + 0.5f);
            return new((start + end) / 2f, sine(waveCount), waveCount * T, (s) => sine(s.AppearTime));
        }
        /// <summary>
        /// Returns a sine wave easing
        ...
        {
            vec2 sine(float t) => Vector2.Lerp(-impact, impact, MathF.Sin((t / T + phase) * MathF.PI * 2) * 0.5f + 0.5f);
            return new(Vector2.Zero, sine(waveCount), waveCount * T, (s) => sine(s.AppearTime));
        }
        /// <summary>
        /// Returns a sine wave easing
        /// </summary>
        ...
        {
            float sine(float t) => MathHelper.Lerp(-impact, impact, MathF.Sin((t / T + phase) * MathF.PI * 2) * 0.5f + 0.5f);
            return new(0, sine(waveCount), waveCount * T, (s) => sine(s.AppearTime));
        }
        #endregion
    }
    ...
    public static class EasingUtil
    {
        ...
        public static class CentreEasing
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, Vector2> Intensify(Func<ICustomMotion, Vector2> easing, Func<ICustomMotion, float> scale) => (s) => easing.Invoke(s) * scale(s);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, Vector2> Combine(Func<ICustomMotion, Vector2> ease1, Func<ICustomMotion, Vector2> ease2) => (s) => ease1.Invoke(s) + ease2.Invoke(s);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, Vector2> Combine(Func<ICustomMotion, Vector2> ease1, Vector2 centre) => (s) => ease1.Invoke(s) + centre;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, Vector2> Combine(Vector2 centre, Func<ICustomMotion, Vector2> ease1) => (s) => ease1.Invoke(s) + centre;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, Vector2> Combine(Func<ICustomMotion, float> xEase, Func<ICustomMotion, float> yEase) => (s) => new(xEase.Invoke(s), yEase.Invoke(s));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, Vector2> PolarCombine(Func<ICustomMotion, Vector2> centreEase, Func<ICustomMotion, float> rotationEase) => (s) => Rotate(centreEase.Invoke(s), rotationEase.Invoke(s));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, Vector2> PolarCombine(Func<ICustomMotion, float> lengthEase, Func<ICustomMotion, float> rotationEase) => (s) => GetVector2(lengthEase.Invoke(s), rotationEase.Invoke(s));
            ...
            private class VirtualEasingObject : GameObject, ICustomMotion
            {
                ...
                static VirtualEasingObject() => ZeroTimeObj = new VirtualEasingObject();
                public Func<ICustomMotion, Vector2> PositionRoute { get; set; }
                public Func<ICustomMotion, float> RotationRoute { get; set; }
                public float[] RotationRouteParam { get; set; }
                public float[] PositionRouteParam { get; set; }
            ...
            public class EaseBuilder
            {
                ...
                public void Run(Action<Vector2> action)
                {
                    ...
                    AddInstance(new TimeRangedEvent(_totalTime, () => action.Invoke(easer.CentrePosition)) { UpdateIn120 = true });
                ...
                public Func<ICustomMotion, Vector2> GetResult()
                {
                    ...
                    Tuple<float, Func<ICustomMotion, Vector2>>[] pairs = [.. motionPairs];
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, float> Convert(Func<float, float> timeParamEase) => (s) => timeParamEase.Invoke(s.AppearTime);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, float> EaseInSine(float v1, float v2, float time) => (s) => MathHelper.Lerp(v1, v2, 1 - MathF.Cos(s.AppearTime / time * MathF.PI / 2));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, float> EaseOutSine(float v1, float v2, float time) =>
                (s) => MathHelper.Lerp(v1, v2, MathF.Sin(s.AppearTime / time * MathF.PI / 2));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, float> LerpTo(float start, float scale, Func<ICustomMotion, float> origin) => (s) => MathHelper.Lerp(start, origin.Invoke(s), scale);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, float> LerpTo(float start, float origin, float scale) => (s) => MathHelper.Lerp(start, origin, scale);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, float> Combine(Func<ICustomMotion, float> ease1, Func<ICustomMotion, float> ease2) => (s) => ease1.Invoke(s) + ease2.Invoke(s);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Func<ICustomMotion, float> Combine(Func<ICustomMotion, float> ease1, float basis) => (s) => ease1.Invoke(s) + basis;
            /// <summary>
            ...
            public class EaseBuilder
            {
                ...
                public void Run(Action<float> action)
                {
                    ...
                    AddInstance(new TimeRangedEvent(_totalTime, () => action.Invoke(easer.Rotation)) { UpdateIn120 = true });
                    AddInstance(new InstantEvent(_totalTime, easer.Dispose));
                }
                private float _totalTime;
