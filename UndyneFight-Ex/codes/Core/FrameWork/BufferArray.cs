...
{
    /// <summary>
    /// A buffer that can dynamically extended
    /// </summary>
    ...
    public sealed unsafe class ExtensibleBuffer<T> where T : unmanaged
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void Extend() => Data = (T*)Marshal.ReAllocHGlobal((IntPtr)Data, new IntPtr(TotalLength * sizeOfT));
