...
namespace UndyneFight_Ex.Entities
{
    public class CashIndicater : Entity
    {
        ...
        {
            UserService.ShopData.ShopCash cash = PlayerManager.CurrentUser.ShopData.CashManager;
    ...
    {
        internal abstract class StoreArea(CollideRect area) : Entity, ISelectAble
        {
            private CollideRect area = area;
