...
namespace UndyneFight_Ex.Entities
{
    ...
    internal class IntroUI : Selector
    {
        ...
        public IntroUI()
        {
            ...
            selectionTextures = [login, mainGame, record, championShip, options, achievements];
            selectionBack = [Color.Lime, col.Red, col.LightSkyBlue, col.Gold, col.Silver, col.Pink];
            selectionIntroduction = ["Login", "Start game", "Records", "Championships", "Options", "My achievements"];
            ...
            if (ClassicalGUI.MainMenuSettings.RecordEnabled)
