            ...
            private void SummaryDraw()
            {
                ...
                else
                {
                    if (accuracy > 0)
                    {
                        ...
                        else
                        {
                            ...
                            NormalFont.Draw(missCount.ToString(), new Vector2(214 + 79, 170), Color.Lerp(Color.Transparent, Color.LightGray, alpha), 1, 0.3f);
                        }

                        NormalFont.Draw("Okay", new Vector2(346, 170), Color.Lerp(Color.Transparent, Color.Green, alpha), 1, 0.3f);
                        NormalFont.Draw(okayCount.ToString(), new Vector2(346 + 79, 170), Color.Lerp(Color.Transparent, Color.LightGray, alpha), 1, 0.3f);
                        NormalFont.Draw("Nice", new Vector2(478, 170), Color.Lerp(Color.Transparent, Color.LightBlue, alpha), 1, 0.3f);
                        NormalFont.Draw(niceCount.ToString(), new Vector2(478 + 79, 170), Color.Lerp(Color.Transparent, Color.LightGray, alpha), 1, 0.3f);
                    }
                    else
                ...
                if (accuracy > 0)
                {
                    ...
                    NormalFont.Draw($"{perfectCount} = {(int)(perfectPercent * 100)}." +
                        $"{(int)(perfectPercent * 10000) - (int)(perfectPercent * 100) * 100}%", new Vector2(214 + 125, 212), Color.Lerp(Color.Transparent, Color.LightGray, alpha), 1, 0.3f);
                    NormalFont.Draw($"Early: {perfectECount} Late: {perfectLCount}", new(214, 235), Color.Lerp(Color.Transparent, Color.Orange, alpha), 0.7f, 0.3f);
