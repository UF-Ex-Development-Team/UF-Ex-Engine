...
internal class IntroUI : Selector
{
	...
	{
		public class User(IntroUI ui) : Model(ui, 0, (ui) => InstanceCreate(string.IsNullOrEmpty(PlayerManager.currentPlayer) ? (PlayerManager.playerInfo.Count != 0 ? new LoginUI() : new RegisterUI()) : new AccountManager())) { }
		...
		{
			private readonly IntroUI father;
