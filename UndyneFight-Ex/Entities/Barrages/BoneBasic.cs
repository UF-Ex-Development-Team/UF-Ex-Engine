...
namespace UndyneFight_Ex.Entities
{
	...
	public class Bone : Barrage
	{
		...
		public override void Draw()
		{
			...
			//spb.Draw(boneHead, Centre - delta, null, Col, GetRadian(Rotation), new Vector2(5, 6), 1.0f, SpriteEffects.None, Depth);
			//spb.Draw(boneTail, Centre + delta, null, Col, GetRadian(Rotation + 180f), new Vector2(5, 3), 1.0f, SpriteEffects.None, Depth);
