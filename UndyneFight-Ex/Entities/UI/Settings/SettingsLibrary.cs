...
namespace UndyneFight_Ex.Settings
{
	internal static class SettingLibrary
	{
		public class MasterVolume : Setting
		{
			...
			public override void Save() => SettingsManager.DataLibrary.masterVolume = Value;
		}
		public class SpearBlockedVolume : Setting
		{
			...
			public override void Save() => SettingsManager.DataLibrary.SpearBlockingVolume = Value;
		}
		public class ReduceBlue : Setting
		{
			...
			public override void Save() => SettingsManager.DataLibrary.reduceBlueAmount = Value;
		}
		public class preciseWarning : Setting
		{
			public static bool Value { get; private set; }
			public preciseWarning(Vector2 centre) : base("Precise Warn", centre)
			{
				UpdateIn120 = true;
				Value = SettingsManager.DataLibrary.preciseWarning;
				showingValue = Value.ToString();
			}
			...
			public override void Save() => SettingsManager.DataLibrary.preciseWarning = Value;
		}
		...
		public class ArrowSpeed : Setting
		{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public override void Save() => SettingsManager.DataLibrary.ArrowSpeed = Value;
		}
		public class ArrowDelay : Setting
		{
			private class DelayHelper : Entity
			{
				public override void Draw()
				{
					...
					GlobalResources.Font.FightFont.CentreDraw(Delta.ToString("F1"), delta + new Vector2(320, 450), Color.Silver * Alpha, 1.0f, 0.0f, 0.99f);
				...
				public DelayHelper() => UpdateIn120 = true;
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public override void Save() => SettingsManager.DataLibrary.ArrowDelay = (int)Value;
		}
		public class ArrowScale : Setting
		{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public override void Save() => SettingsManager.DataLibrary.ArrowScale = Value;
		}
		public class IsMirror : Setting
		{
			...
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public override void Save() => SettingsManager.DataLibrary.Mirror = Value;
		}
		public class DrawingQualitySetter : Setting
		{
			...
			public override void Save() => SettingsManager.DataLibrary.drawingQuality = Value;
		}
	}
}