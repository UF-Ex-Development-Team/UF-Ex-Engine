...
{
	/// <summary>
	/// Random thing I made because <see cref="Entities.EasingUtil"/> returns inaccurate values for certain easing functions (Mostly EaseIn and EaseInOut/OutIn functions)<br/>
	...
	public static class TKValueEasing
	{
		...
		//Linear Easing
		public static float EaseLinear(float _time, float _start, float _change, float _duration) => _change * _time / _duration + _start;
		public static float EaseLinear(int _time, int _start, int _change, int _duration) => _change * _time / _duration + _start;

		///Quadratic Easing
		public static float EaseInQuad(float _time, float _start, float _change, float _duration) => -_change * Pow(_time / _duration, 2) + _start;
		public static float EaseOutQuad(float _time, float _start, float _change, float _duration) => _change * _time / _duration * (_time / _duration - 2) + _start;
		...
		//Cubic Easing
		public static float EaseInCubic(float _time, float _start, float _change, float _duration) => _change * Pow(_time / _duration, 3) + _start;
		public static float EaseOutCubic(float _time, float _start, float _change, float _duration) => _change * (Pow(_time / _duration - 1, 3) + 1) + _start;
		...
		//Quart Easing
		public static float EaseInQuart(float _time, float _start, float _change, float _duration) => _change * Pow(_time / _duration, 4) + _start;
		public static float EaseOutQuart(float _time, float _start, float _change, float _duration) => _change * -(Pow(_time / _duration - 1, 4) - 1) + _start;
		...
		//Quint Easing
		public static float EaseInQuint(float _time, float _start, float _change, float _duration) => _change * Pow(_time / _duration, 5) + _start;
		public static float EaseOutQuint(float _time, float _start, float _change, float _duration) => _change * -(Pow(_time / _duration - 1, 5) - 1) + _start;
		...
		//Sine
		public static float EaseInSine(float _time, float _start, float _change, float _duration) => _change * (1 - Cos(_time / _duration * (PI / 2f))) + _start;
		public static float EaseOutSine(float _time, float _start, float _change, float _duration) => _change * Sin(_time / _duration * (PI / 2f)) + _start;
		public static float EaseInOutSine(float _time, float _start, float _change, float _duration) => _change * 0.5f * (1 - Cos(PI * _time / _duration)) + _start;

		//Circ
		public static float EaseInCirc(float _time, float _start, float _change, float _duration) => _change * (1 - Sqrt(1 - _time / _duration * _time / _duration)) + _start;
		...
		//Expotential
		public static float EaseInExpo(float _time, float _start, float _change, float _duration) => _change * Pow(2, 10 * (_time / _duration - 1)) + _start;
		public static float EaseOutExpo(float _time, float _start, float _change, float _duration) => _change * (-Pow(2, -10 * _time / _duration) + 1) + _start;
		...
		//Bounce
		public static float EaseInBounce(float _time, float _start, float _change, float _duration) => _change - EaseOutBounce(_duration - _time, 0, _change, _duration) + _start;
		...
		public static float EaseInOutBounce(float _time, float _start, float _change, float _duration) => _time < _duration * 0.5f ? EaseInBounce(_time * 2, 0, _change, _duration) * 0.5f + _start
