...
namespace UndyneFight_Ex
{
	public static partial class GlobalResources
	{
		...
		{
			/// <summary>
			/// Shader class for <see cref="FightResources.Shaders.Camera"/>, it is best to have knowledge of camera matrix before using this
			/// </summary>
			public class CameraShader : Shader
			{
				...
				public Vector3 ProjectAxisX { get; set; } = Vector3.UnitX;
				public Vector3 ProjectAxisY { get; set; } = Vector3.UnitY;
				public Vector3 ProjectAxisZ { get; set; } = Vector3.UnitZ;
				...
				public Vector3 CameraAhead { get; set; } = Vector3.UnitZ;
				public Vector3 CameraRight { get; set; } = new Vector3(1, 0, 0);
				public Vector3 CameraDown { get; set; } = Vector3.UnitY;
			}
		}
	}
}