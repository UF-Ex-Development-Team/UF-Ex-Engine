...
public partial class Arrow
{
	...
	{
		InstanceCreate(new BreakArrow(Speed, Rotation + additiveRotation + (Mission.Shields.GetShield(ArrowColor)?.deltaRotation ?? 0) * 6, ArrowColor, rotatingType, Centre, Scale * DrawingScale));
