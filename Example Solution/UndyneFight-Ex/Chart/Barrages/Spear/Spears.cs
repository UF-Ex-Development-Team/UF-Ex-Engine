...
public class SwarmSpear(Vector2 rotateCentre, float linearSpeed, float distance, float rotation, float waitingTime) : Spear
{
	...
	private int appearTime = 0;
	private float linearSpeed = linearSpeed, distance = distance;
	private readonly float waitingTime = waitingTime, missionRotation = rotation, acceleration = 0.15f;
...
public class CircleSpear : Spear
{
	...
	private int appearTime = 0;
	private float rotateSpeed, distance;
	private readonly float rotateFriction = 0.01f, rotateAngleDisplace = 0, linearSpeed;
	/// <summary>
	/// Creates a spear that moves around the target with a circular motion
	/// </summary>
	/// <param name="rotateCentre">The center of the circle</param>
