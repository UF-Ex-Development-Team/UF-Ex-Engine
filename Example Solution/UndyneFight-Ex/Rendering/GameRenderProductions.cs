...
{
	/// <summary>
	/// The surface used for drawing the game
	/// </summary>
	public static Texture2D ApplicationSurface => GameMain.ApplicationSurface;
	/// <summary>
	/// Aspect ratio of the game
	/// </summary>
	public static float Aspect => GameMain.Aspect;
	/// <summary>
	...
	internal static RenderTarget2D DrawAll() => MainScene.Draw(null);
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
