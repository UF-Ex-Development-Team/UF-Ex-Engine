...
public class SongPlayData
{
	...
	public static bool HasModifier(GameMode mode) => (mode & GameMode.NoGreenSoul) != 0 || (mode & GameMode.Practice) != 0 || (mode & GameMode.Autoplay) != 0;

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public bool HasModifier() => HasModifier(GameMode);
